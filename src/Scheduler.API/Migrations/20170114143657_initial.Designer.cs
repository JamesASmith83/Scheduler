...
namespace Scheduler.API.Migrations
{
    ...
    [Migration("20170114143657_initial")]
            ...
            modelBuilder.Entity("Scheduler.Model.Entities.Schedule", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 1, 14, 14, 36, 57, 313, DateTimeKind.Local));

                    b.Property<DateTime>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 1, 14, 14, 36, 57, 321, DateTimeKind.Local));
